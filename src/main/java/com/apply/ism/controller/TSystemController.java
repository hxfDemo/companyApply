...
//                String path = Catalog+file[0].getOriginalFilename();
    ...
    public Result getScore(String nd, String projectName, Long ascription, String company, Long hierarchy, Long tontru, Long evaluationId,Integer current,Integer size){
        try {
            ...
            PageInfo<Map<String, Object>> page = new PageInfo<Map<String, Object>>(materialInfos);
